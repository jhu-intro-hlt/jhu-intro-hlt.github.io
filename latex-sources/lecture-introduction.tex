...
\item \textbf{TA:} Xiluo He (xhe69@jhu.edu)
...
\slide{LLMs at the Center of Agentic AI}
\vfill
\begin{center}
{\bf Example: Claude Code}\\
LLMs driving the Agent Loop\\[2cm]
\includegraphics[width=23cm]{claude-code-system-structure.png}
\end{center}
\vfill
